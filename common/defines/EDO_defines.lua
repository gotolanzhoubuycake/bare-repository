...
NDefines.NGame.ENERGY_RESOURCE = "resources_el"						-- resource that will give country fuel
...
NDefines.NCountry.POPULATION_YEARLY_GROWTH_BASE = 0.015
NDefines.NDiplomacy.BASE_IMPROVE_RELATION_COST = 75

NDefines.NTechnology.BASE_TECH_COST = 165

NDefines.NAir.COMBAT_BETTER_SPEED_DAMAGE_INCREASE = 0.4
